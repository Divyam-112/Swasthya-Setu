...
const sessionSchema = new mongoose.Schema(
  {
    ...
    // Q&A responses captured during the kiosk intake
    responses: [
      {
        questionId: String,
        question: String,
    ...
    // The patient reviews the generated history and corrects anything
    // wrong before it reaches the doctor. Corrections are kept
    // alongside the original wording so the doctor can see what the
    // patient changed, not just the final value.
    patientVerification: {
      verifiedAt: Date,
      corrections: [
        {
