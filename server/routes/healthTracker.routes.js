...
router.post("/medicine-log", addMedicineLog);
router.get("/medicine-logs", getMedicineLogs);
router.delete("/medicine-log/:logId", deleteMedicineLog);
router.post("/exercise-log", addExerciseLog);
router.get("/exercise-logs", getExerciseLogs);
router.delete("/exercise-log/:logId", deleteExerciseLog);
